...
function initializeEventListeners() {
    ...
    for (let category of categories) {
        category.addEventListener("click", (evt) => {
            console.log("Search results page for category", category.querySelector(".category-name p").innerText);
            searchQuery(category.querySelector(".category-name p").innerText);
        });
    }
}
